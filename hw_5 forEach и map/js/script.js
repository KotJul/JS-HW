//  Не используйте цикл for только forEach и map !!!
// Задача 1
...
// №2 Найдите сумму элементов массива между двумя первыми нулями
// №3 Найдите наименьший четный элемент массива
// №4 Найдите сумму номеров минимального и максимального элементов
// №5 Создайте массив в котором будут только положительные числа исходного массива
// №6 Округлите все числа массива
// №7 Округлите все числа до целого вверх

// №1 Найдите сумму отрицательных элементов массива
let sumNeg = 0;
arr.forEach( (e,index) =>{ if (e < 0) sumNeg +=e});
console.log(sumNeg);

// №2 Найдите сумму элементов массива между двумя первыми нулями
let minChElem = 0;
arr.forEach( (e) => { if(e % 2 ===0) minChElem < e});
console.log(minChElem);// №3 Найдите наименьший четный элемент массива
...
arr.forEach((e) => { 
  ...
  sum += max + min;
console.log(max,min,sum);// №4 Найдите сумму номеров минимального и максимального элементов


 let onlyPosNumber = arr.map((e) => e > 0);// №5 Создайте массив в котором будут только положительные числа исходного массива
 console.log(onlyPosNumber);


let round = arr.map((e) => e.toFixed(1));
console.log(round);// №6 Округлите все числа массива

// №7 Округлите все числа до целого вверх

let roundToInteger = arr.map((e) => e.toFixed(0));/*просто округленно до целого не вверх*/
console.log(roundToInteger);
...
// №1 Посчитайте количество пробелов в строке
// №2 Посчитайте количество слов длина которых больше 5
// №3 Найдите сумму всех чисел из текста
// №4 Сделайте все слова строчными (с маленькой буквы)
// №5 Удалите в словах среднюю букву (если она есть)


// №1 Посчитайте количество пробелов в строке
// let arr2 = str.split(' ');/*разбили на масивы*/
